...
const Banner = ({netflixOriginals}: Props) => {
  ...
  return (
    <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
      ...
      <h1 className="text-2xl font-boldmd:text-4xl md:text-4xl lg:text-7xl ">
      ...
      <div>
        <button className="bannerButton"><FaPlay/> Phát</button>
        <button className="bannerButton">Thông tin khác</button>
      </div>
    </div>
  )
}
