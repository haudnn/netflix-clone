...
import { PlusIcon, ThumbUpIcon, VolumeOffIcon, XIcon,VolumeUpIcon } from '@heroicons/react/outline'
                ...
                <div className="relative pt-[56.25%]">
                    ...
                    <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
                        <div className="flex space-x-2">
                            ...
                            <button className="modalButton">
                                <ThumbUpIcon className="h-7 w-7"></ThumbUpIcon>
                            </button>
                        </div>
                        <button className="modalButton" onClick={() => setMuted(!muted)}>{muted ? <VolumeOffIcon  className="h-6 w-6"/> : <VolumeUpIcon  className="h-6 w-6"/>}</button>
                    </div>
                </div>
                <div>
                    <div className="space-y-6 text-lg">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col space-y-3 text-sm">
                                <div>
                                    <span className="text-[gray]">Genre s: </span>
